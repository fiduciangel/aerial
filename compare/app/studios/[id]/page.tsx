    ...
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
        ...
        <div>
          ...
          <div className="mt-2 flex flex-wrap items-center gap-3">
            ...
            <span className="text-sm text-slate-500">
              捷運 <span className="font-medium text-slate-700">{studio.mrt_station}</span>
            </span>
          </div>
        </div>
        <Link
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_360px]">
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-lg font-bold text-slate-900">費用</h2>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {studio.pricing.package.map((p) => (
                      <tr key={p.sessions}>
                        ...
                        <td className="px-4 py-2.5 text-slate-700">{ntd(p.price)}</td>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900">關於這間教室</h2>
            <p className="mt-2 leading-relaxed text-slate-600">{studio.notes}</p>
          </section>
        ...
        <aside className="space-y-3">
          <div className="rounded-2xl border border-slate-200 bg-white p-4">
            <h2 className="text-sm font-bold text-slate-900">地點</h2>
            <p className="mt-1 text-sm text-slate-600">{studio.address}</p>
            <p className="mt-1 text-sm text-slate-500">鄰近 {studio.mrt_station}</p>
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block rounded-lg bg-slate-100 py-2 text-center text-sm font-semibold text-slate-700 hover:bg-slate-200"
          >
            在 Google 地圖開啟
          </a>
        </aside>
...
function PriceStat({
  ...
  return (
    <div className="rounded-xl bg-slate-50 p-3 text-center">
      ...
      <p className={`mt-0.5 text-lg font-bold ${accent ? "text-ochre-500" : "text-slate-800"}`}>
        {value}
      </p>
    </div>
  );
